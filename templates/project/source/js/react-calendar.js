	...
	return /******/ (function(modules) { // webpackBootstrap
		...
		({
			...
			/***/
				...
				// handleClick alert - //cp
				function handleClick(scope, m, e) {
					console.log("handleClick: " + scope + " " + m.format("YYYY-MM-DD"));

					// 將格式化日期回傳至需求頁面1
					// var m_format = m.format();
					// filter_weeks_holiday.select_weeks(moment(m_format).format("YYYY-MM-DD"));

					// 將格式化日期回傳至需求頁面2
					//2 e.dispatchMarker 為 data attr
					//2 filter_weeks_holiday.select_weeks(e.dispatchMarker, moment(m_format).format("YYYY-MM-DD"));
					//2 console.log(moment("2015-03-13").dayOfYear());
				};

				var PagingCalendar = React.createClass({
					displayName: 'PagingCalendar',
					// getInitialState: function(year) {
					...
					handlePrevYear: function(e) {
						...
						// console.log(this.getCalendarCtx());
					...
					render: function() {
						// var _cur_year = moment().format("YYYY") * 1;
							...
							React.createElement("div", null,
								...
								React.createElement(Calendar, {
									...
									React.createElement(Month, {
										...
										// onClick: handleClick // 因重複執行, 故暫移除
									}),
									React.createElement(Day, {
										date: moment(),
										modifiers: {
					...
					render: function() {
						return React.withContext(this.getCalendarCtx(), function() {
							...
							return React.DOM.div(props, [
								...
								React.createElement("div", {
										key: "days",
										className: classes.descendant('days')
									},
									days
								)
							]);
			...
			7:
			/***/
				function xxx7(module, exports, __webpack_require__) {
					...
					render: function() {
						return React.withContext(this.getCalendarCtx(), function() {
							...
							var props = _.assign({
								className: classes(),
								// 回傳格式化日期 - //cp
								data: moment(this.props.date).format("YYYY-MM-DD")
							}, this.getEventHandlers());
				...
				*/
				...
				function listToStyles(list) {
					...
					for (var i = 0; i < list.length; i++) {
						...
						var part = {
							css: css,
							media: media /*, sourceMap: sourceMap*/
						};
						if (!newStyles[id])
			...
			/***/
				...
				module.exports.Mixin = function(addContext) {
					for (var types = [], $__0 = 1, $__1 = arguments.length; $__0 < $__1; $__0++) types.push(arguments[$__0]);
			...
			/***/
				...
				ClassNamer.prototype.descendants = function() {
					for (var descendants = [], $__0 = 0, $__1 = arguments.length; $__0 < $__1; $__0++) descendants.push(arguments[$__0]);
			...
			/***/
				...
				}.call(exports, __webpack_require__(86)(module), (function() {
					return this;
				}())))
